...
class MarketDataClient:
    ...
    def fetch_candles(self, instrument, granularity="M15", count=100, price_type="M"):
        ...
        params = {"count": count, "granularity": granularity, "price": price_type}
    ...
    def candles_to_dataframe(self, parsed_candles):
        """convert parsed candles to dataframe"""
    ...
    def get_latest_price(self, instrument):
        """get latest bid/ask/mid for one instrument"""
...
def load_data_from_csv(csv_path):
    """load and reformat csv data to OHLC"""
