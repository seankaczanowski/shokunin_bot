...
export interface IProviderReconciliator {
     ...
     */
    fetchInline(request: CompletionHandler.IRequest, trigger?: InlineCompletionTriggerKind, isMiddleOfLine?: boolean): Promise<IInlineCompletionList<CompletionHandler.IInlineItem> | null>[];
    /**
