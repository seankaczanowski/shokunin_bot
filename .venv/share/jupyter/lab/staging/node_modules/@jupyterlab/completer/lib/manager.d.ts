...
import { ICompleterSelection, ICompletionContext, ICompletionProvider, ICompletionProviderManager, IInlineCompleterActions, IInlineCompleterFactory, IInlineCompletionProvider, IInlineCompletionProviderInfo } from './tokens';
/**
...
export declare class CompletionProviderManager implements ICompletionProviderManager {
    ...
    private _suppressIfInlineCompleterActive;
}
