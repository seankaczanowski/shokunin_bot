...
class ProxyAudit extends _core.pluginUtils.Plugin {
  constructor(config, options) {
    ...
    this.timeout = (_config$timeout = config.timeout) !== null && _config$timeout !== void 0 ? _config$timeout : 1000 * 60 * 1;
  ...
  register_middlewares(app, auth) {
    const fetchAudit = async (req, res) => {
      ...
      if (auth !== null && auth !== void 0 && (_auth$config = auth.config) !== null && _auth$config !== void 0 && _auth$config.https_proxy) {
        ...
        const agent = (0, _httpsProxyAgent.default)(auth === null || auth === void 0 || (_auth$config2 = auth.config) === null || _auth$config2 === void 0 ? void 0 : _auth$config2.https_proxy);
